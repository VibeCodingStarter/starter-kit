...
export default function GenericComponentsPage() {
  const TOC_ITEMS = {
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <PageHeader
          ...
          description="Reusable components that can be used across different projects."
        />
        ...
        <div className="max-w-5xl mx-auto px-4 py-8">
          ...
          <section>
            ...
            {Object.entries(COMPONENT_DATA.genericComponents).map(
              ([id, data]) => (
